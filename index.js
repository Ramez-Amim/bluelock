...
//CHAT GPT 
//prompt: Schrijf een JavaScript-functie die een animatie reset, pointer events uitschakelt, een tekstveld leegt en een score terugzet naar nul. De variabelen heten 'siuuBericht', 'terugkoppeling', 'score', en 'scoreWeergave'.
function resetSiuu() {
...
function klikHandler(event) {
  ...
  if (knopId === "sterk") {
    afbeelding.src = "rechts.png"; //alle afbeeldingen gegereerd met chatgpt
  } else if (knopId === "zwak") {
  ...
  if (kans < 0.5) {
    ...
    terugkoppeling.textContent = "MIS! Zo haal je het niet vriend, KOM OP!";
  }
}
